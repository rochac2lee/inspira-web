...
class SecondaryToolbar {
  ...
  #bindSpreadModeListener({
    ...
    function spreadModeChanged({
      ...
      const isOdd = mode === _ui_utils.SpreadMode.ODD,
        isNone = mode === _ui_utils.SpreadMode.NONE,
...
class Toolbar {
  ...
  async #adjustScaleWidth() {
    ...
    const predefinedValuesPromise = Promise.all([l10n.get("page_scale_fit"), l10n.get("page_scale_actual"), l10n.get("page_scale_auto"), l10n.get("page_scale_width")]);
