...
$(document).ready(function () {
    ...
    $('#subm').on('click', function () {
        ...
        $('#formNovaAvaliacao :input[required]').each(function () {
        ...
        if (preenchido == true) {
            ...
            document.getElementById('formNovaAvaliacao').submit();
        }
    }); */
...
function removerCurso(id) {
    ...
    ordem = parseInt(ordem) + 1;
    $('div.box-cursos-add').append('<input type="text" id="curso_id_' + idCurso + '" name="curso_id[]" value="' + idCurso + '">');
    $('div.box-cursos-add').append('<input type="text" id="curso_id_ordem_' + idCurso + '" name="curso_id_ordem_' + idCurso + '" value="' + ordem + '">');
    $('#ordem').val(ordem);
