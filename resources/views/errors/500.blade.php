        ...
        <div class="container">
            <div class="row text-center">
                <div class="col-md-12 col-sm-12 grid-item ">
                    <img class="img-fluid" src="{{config('app.app')}}/fr/imagens/erro/500.webp" style="max-width:800px;" />
                    <br>
                    <br>
                    <div class="alert alert-info" role="alert">
                        <h6>Ops! <b>Acho que algo deu errado!</b> Se o problema persistir, por favor contate o nosso suporte.</h6>
