    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Publicar Tarefa</h5>
            </div>
            <div class="modal-body">
                <form action="">
                    <div class="row">
                        <div class="col-12">
                            Você deseja mesmo publicar esta tarefa?<br><br>
                            <b id="nomeComuncadoPublicar"></b><br><br>
                            <p class="text-justify"><b >ATENÇÃO:</b> Ao publicar, todos os usuários receberão imediatamente a comunicação e a ação NÃO poderá ser desfeita.</p>
