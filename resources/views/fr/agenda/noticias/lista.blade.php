            ...
            <div class="row pb-4">
                ...
                @if(auth()->user()->permissao != 'P')
                    <div class="col-md-8 text-right">
                        <a href="{{url('gestao/agenda/noticias/novo')}}" class="btn btn-success" >
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right text-nowrap">
                                            ...
                                            @if($d->publicado == 0 && ( auth()->user()->permissao == 'I' ||  (auth()->user()->permissao == 'P' && $d->user_id == auth()->user()->id) || (auth()->user()->permissao == 'C' && ($d->user_id == auth()->user()->id || $d->permissao_usuario == 'P') ) )  )
                                                ...
                                                <span><a href="{{url('/gestao/agenda/noticias/imagens/'.$d->id)}}"  class="btn btn-success btn-sm fs-13" data-toggle="tooltip" data-placement="top" title="Gerenciar imagens"><i class="fas fa-images"></i> </a></span>
                                                <span><a href="{{url('/gestao/agenda/noticias/editar/'.$d->id)}}" class="btn btn-success btn-sm fs-13" data-toggle="tooltip" data-placement="top" title="Editar"><i class="fas fa-pencil-alt"></i></a></span>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Exclusão de Notícia</h5>
                </div>
                <div class="modal-body">
                    <form action="">
                        <div class="row">
                            <div class="col-12">
                                Você deseja mesmo excluir essa notícia?<br><br>
    ...
    <div class="modal fade" id="formVisualizar" tabindex="-1" role="dialog" aria-labelledby="formVisualizar" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h5 class="modal-title">Visualizar Notícia</h5>
                </div>
                <div class="modal-body">
                    <form action="">
                        <div class="row">
...
<script>
    ...
    function excluir()
    {
        window.location.href = '{{url("/gestao/agenda/noticias/excluir")}}/'+idExcluir;
    }
    ...
    function publicar()
    {
        window.location.href = '{{url("/gestao/agenda/noticias/publicar")}}/'+idPublicar;
    }

    function modalVisualizar(id)
    {
        $.ajax({
            url: '{{url('gestao/agenda/noticias/exibir')}}/'+id,
            type: 'post',
            dataType: 'json',
            data: {
                _token: '{{csrf_token()}}'
            ...
            error: function () {
                swal("", "Não foi possível carregar o notícia.", "error");
            }
        });
