                        ...
                        <form class="form-inline d-flex justify-content-end">
                            ...
                            <div class="input-group ml-1">
                                <select class="form-control" name="tipo">
                                    ...
                                    <option @if(Request::input('tipo') == '1') selected @endif value="1">Autorizados</option>
                                    <option @if(Request::input('tipo') == '2') selected @endif value="2">Não Autorizados</option>
                                    <option @if(Request::input('tipo') == '3') selected @endif value="3">Não Respondidos</option>
                                </select>
                            </div>
                            <div class="input-group ml-1">
            ...
            <div class="row pb-4">
                <div class="col-md-12">
                    <h3>
                        ...
                        Autorizações respondidas <small><br>{{$autorizacao->titulo}}</small>
                    </h3>
                </div>
            </div>
            <div class="row">
                                ...
                                @foreach($dados as $d)
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-right text-nowrap">
                                            @if(isset($d->autorizado) && $d->autorizado == 1)
                                                <span class="badge badge-success">Autorizado<br>{{$d->updated_at->format('d/m/Y H:i:s')}}<br>{{$responsavel}}</span>
                                            @elseif(isset($d->autorizado) && $d->autorizado == 0)
                                                <span class="badge badge-danger">Não Autorizado<br>{{$d->updated_at->format('d/m/Y H:i:s')}}<br>{{$responsavel}}</span>
                                            @else
