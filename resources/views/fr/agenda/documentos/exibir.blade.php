<div class="row">
    ...
    <div class="col-12 text-justify">
        <p>
            <b>Anexo:</b>
            <a href="{{url('gestao/agenda/documentos/arquivo/donwload/'.@$dados->id)}}"><span class="badge badge-info">{{$dados->nome_arquivo_original}} <i class="fas fa-download"></i></span></a>
        </p>
    </div>
    @endif
