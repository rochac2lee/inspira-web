            ...
            <div class="row pb-4">
                <div class="col-md-12">
                    <h3>
                        ...
                        Documentos recebidos <small><br>{{$documento->titulo}}</small>
                    </h3>
                </div>
            </div>
            <div class="row">
                            ...
                            <tbody>
                                @foreach($dados as $d)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            {{$estudante}}
                                            <small><br> {{$d->qtd}} arquivo(s) recebido(s)</small>
                                        </td>
                                        <td class="text-right text-nowrap">

                                            <span><button onclick="modalVisualizar({{$d->aluno_id}}, {{$d->turma_id}}, {{$d->documento_id}} , '{{$estudante}}', '{{$d->turma}}', '{{$d->ciclo_etapa}} / {{$d->ciclo}}')" class="btn btn-success btn-sm fs-13" data-toggle="tooltip" data-placement="top" title="Arquivos Recebidos"><i class="far fa-images"></i></button></span>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
