...
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/froala_editor.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/froala_style.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/code_view.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/draggable.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/colors.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/emoticons.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/image_manager.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/image.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/line_breaker.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/table.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/char_counter.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/video.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/fullscreen.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/file.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/quick_insert.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/help.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/third_party/spell_checker.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/plugins/special_characters.css">
<link rel="stylesheet" href="{{config('app.cdn')}}/fr/includes/froala_editor_indica/css/codemirror.min.css">
    ...
    <div class="row">
        <div class="col-md-12">
            <h4 class="pb-1 border-bottom mb-4">
                <a href="{{url('/indica/gestao/questao/')}}" class="btn btn-secondary ml-3">
                    <i class="fas fa-arrow-left"></i>
                </a>
                INdica - @if ( strpos(Request::path(),'editar')===false )Nova questão @else Editar questão @endif
            </h4>
        </div>
    </div>
  ...
  */
	            ...
	            <div class="col-md-6 pl-5">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control form-control-sm rounded" name="codigo" value="{{old('codigo',@$dados->codigo)}}">
                        <div class="invalid-feedback @if($errors->first('codigo'))d-block @endif" style="font-size: 12px">{{ $errors->first('codigo') }}</div>
	                ...
	                <div class="form-group mt-3">
	                    ...
	                    <select name="cicloetapa_id" id="cicloetapa_id" class="multiple2 {{ $errors->has('cicloetapa_id') ? 'is-invalid' : '' }}" single onchange="getUnidadeTematica()">
	                        ...
	                        @foreach($cicloEtapa as $d)
								@if($d->ciclo!="Ensino Médio" && $d->ciclo_etapa!="Todos" && $d->ciclo_etapa!="*" && $d->ciclo_etapa!="NEM" && $d->ciclo_etapa!="Especial")
	                ...
	                <div class="container px-lg-5 fs-12 mb-4">
	                    <div class="row mx-lg-n5">
	                        <div class="col border bg-light p-2">
	                            <h5>Resolução da questão</h5>

	                            <div id="respotaQuestao">
	                ...
	                <a href="{{url('/indica/gestao/questao/')}}" class="btn btn-secondary float-left" >Cancelar</a>
       ...
       <!--  Exclusivo Froala Editor  -->
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/codemirror.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/xml.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/purify.min.js"></script>

  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/froala_editor.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/align.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/code_beautifier.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/code_view.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/colors.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/draggable.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/font_size.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/font_family.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/image.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/line_breaker.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/inline_style.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/lists.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/paragraph_format.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/paragraph_style.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/word_paste.min.js"></script>
  <script type="text/javascript" src='{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/languages/pt_br.js'></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/special_characters.min.js"></script>
  <script type="text/javascript" src="{{config('app.cdn')}}/fr/includes/froala_editor_indica/js/plugins/table.min.js"></script> <!--  FIM Froala Editor  -->

<!-- Codigo para adicionar a matemática-->
<script type="text/javascript" src="{{url('/fr/includes/froala_editor_indica/node_modules/wiris/mathtype-froala3/wiris.js')}}"></script>

<!-- Codigo para mostrar o resultado --->
<script type="text/javascript" src="{{url('/fr/includes/froala_editor_indica/js/plugins/froala_wiris/integration/WIRISplugins.js?viewer=image')}}"></script>
  ...
  /// wiris
   ...
   toolbarButtons: {
          ...
          'moreParagraph': {
            'buttons': ['alignLeft', 'alignCenter', 'formatOLSimple', 'alignRight', 'alignJustify', 'formatOL', 'formatUL', 'paragraphFormat', 'paragraphStyle', 'lineHeight', 'outdent', 'indent', 'quote', 'insertTable']
          },
          'moreRich': {
            'buttons': ['insertLink', 'insertImage', 'insertVideo', 'emoticons', 'fontAwesome', 'specialCharacters', 'embedly', 'insertFile', 'insertHR']
          },
          'more':{
