	...
	<div class="container">
								...
								<div class="form-row">
                                    ...
                                    <div class="form-group col-md-9 ">
                                        <div class="col text-right">
                                            ...
                                            <a href="{{url('indica/gestao/questao')}}" class="btn btn-danger fs-13" title="Limpar Filtro"><i class="fas fa-undo-alt"></i> Limpar todos os filtros</a>
                                        </div>
                                    </div>
								</div>
		...
		<div class="row  pb-4" >
            ...
            <div class="col-md-6 text-right">
                <span class="mr-5 "><a href="{{url('indica/gestao/avaliacao')}}" class="btn btn-warning text-white"><i class="fas fa-list"></i> Avaliações</a></span>
				<span><a href="{{url('indica/gestao/questao/importa')}}" class="btn btn-info"><i class="fas fa-file-upload"></i> Importar Questões</a></span>
				<span><a href="{{url('indica/gestao/questao/nova')}}" class="btn btn-success"><i class="fas fa-plus"></i> Criar Nova Questão</a></span>
			</div>
		</div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right text-nowrap">
                                        <span>
                                            <a href="{{url('/indica/gestao/questao/duplicar/'.$d->id)}}" class="btn btn-secondary btn-sm fs-13" data-toggle="tooltip" data-placement="top" title="@if(Request::input('biblioteca') == 1 ) Adicionar as minhas questões @else Duplicar @endif">
                                        ...
                                        <span><button onclick="exibir({{$d->id}})" class="btn btn-secondary btn-sm fs-13" data-toggle="tooltip" data-placement="top" title="Ver Questão"><i class="fas fa-eye"></i></button></span>
                                            <span><a href="{{url('/indica/gestao/questao/editar/'.$d->id)}}" class="btn btn-secondary btn-sm fs-13" data-toggle="tooltip" data-placement="top" title="Editar Questão"><i class="fas fa-pencil-alt"></i></a></span>
...
<script type="text/javascript">
	...
	function excluir()
    {
        window.location.href = '{{url("/indica/gestao/questao/excluir")}}/'+idExcluir;
    }

    function exibir(id)
    {
        url = '{{url('/indica/gestao/questao/ver')}}/'+id;
    ...
    function mudaRevisao(idQuestao,elemento,tipo)
    {
        ...
        $.ajax({
                url: '{{url('/indica/gestao/questao/mudaStatus')}}',
                type: 'post',
                dataType: 'json',
                data: dados,
                error: function(data) {
