<div class="item bg-2">
    <div class="banner mx-auto">
        <div class="borda"></div>
        <div class="titulo">Familiar / Responsável</div>
        <div class="user-desc">
            <img src="{{config('app.cdn')}}/fr/imagens/2021/user-2.png">
            <p class="mt-3 mb-3">{{$d->instituicao->titulo}}</p>
            <form action="{{url('/multiplasPermissoes/entrar')}}" method="post">
                ...
                <div class=" input-group">
                    <select name="aluno_id" class="form-control mb-3 ml-2 mr-2">
                        @foreach($d->vetAlunos as $key => $value)
