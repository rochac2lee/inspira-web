...
@section('content')
    ...
    <section class="section section-interna">
        <div class="container">
            ...
            <h2 class="title-page">
                ...
                Coleções de Documentos Oficiais Permitidos<br><small>{{$escola->titulo}}</small>
            </h2>
                <form action="{{url('/gestao/escola/material/addColecaoDocumento/')}}" method="post">
                    <div class="form-row">
                            ...
                            <div class="card text-center">                          
                                ...
                                <div class="card-footer">  
                                    ...
                                    <div id="etapa{{$d->id}}" style="display: none;" class="text-left"> 
                                        <form action="{{url('/gestao/escola/material/permissaoColecaoAudio')}}" method="post" >
                                            <br><br>
                                            @csrf
                                            <input type="hidden" name="escola_id" value="{{$escola->id}}">
    ...
    <script>
        ...
        function excluir()
        {
            window.location.href = '{{url('/gestao/escola')}}/' + vescolaId + '/material/removerColecaoDocumento/' + vcolecaoId;
        }
