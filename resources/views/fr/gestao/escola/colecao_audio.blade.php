...
@section('content')
    ...
    <section class="section section-interna">
        <div class="container">
            ...
            <h2 class="title-page">
                ...
                Coleções de Áudios Permitidos<br><small>{{$escola->titulo}}</small>
            </h2>
                <form action="{{url('/gestao/escola/material/addColecaoAudio/')}}" method="post">
                    <div class="form-row">
    ...
    <script>
        ...
        function excluir()
        {
            window.location.href = '{{url('/gestao/escola')}}/' + vescolaId + '/material/removerColecaoAudio/' + vcolecaoId;
        }
