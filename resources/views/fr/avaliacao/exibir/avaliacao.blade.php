    ...
    <section class="section section-interna" style="padding-top: 30px">
        <div class="container">
            <div class="row title-page">
                <div class="col-8">
                    <h2 >
                        Avaliação INterativa - {{$avaliacao->titulo}}
...
<section class="section">
    ...
    <div class="container">
        ...
        <h2 class="text-left mt-3" >
            @php $i=1; @endphp
            <form id="formFinalizar" method="post" action="{{url('/avaliacao/finalizar')}}">
                @csrf
...
<script>
    ...
    function enviaLogAtividade(obj,token){
        $.ajax({
            url: '{{url('/avaliacao/logAtividade')}}',
            type: 'post',
            dataType: 'json',
            data: {
                obj: obj,
