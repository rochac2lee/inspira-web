    ...
    <section class="section section-interna" style="padding-bottom: 15px" >
        <div class="container">
            <h2 class="title-page">
                ...
                Avaliação on-line - {{$avaliacao->titulo}}
            </h2>
        </div>
                ...
                <div class="row">
                    <div class="col-md-6 bg-light border-right pt-4 pb-4 pl-4 pr-5">
                        ...
                        <div class="col border p-2 text-center statsPerformace">
                            ...
                            <div class="row">
                                <div class="col col-md-12"><div class="a a1"><label>@if($avaliacao->tipo_peso == 1) {{number_format($avaliacao->peso*$dados->qtd_questoes_total,2,',','.')}} @else {{number_format($avaliacao->peso,2,',','.')}} @endif</label>Peso da avaliação</div></div>
                                ...
                                <div class="col col-md-6"><div class="a a3"><label>{{$dados->qtd_questao_para_avaliar}}</label>Respostas<br>aguardando correção</div></div>
                                <div class="col col-md-6"><div class="a a4"><label>{{$dados->tempo_total}}</label> Tempo total nesta avaliação (h:m:s)</div></div>
                                @php // <div class="col col-md-6"><div class="a a4"><label>{{$dados->tempo_inativo}}</label> Tempo total fora da avaliação (h:m:s)</div></div> @endphp
                                <div class="col col-md-6"><div class="a a4"><label>{{number_format($dados->peso_total_acerto,2,',','.')}}</label>Sua nota / <br>Seu conceito<br> </div></div>
                                <!--
