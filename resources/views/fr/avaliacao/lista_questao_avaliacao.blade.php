	...
	<li id="questao{{$d->id}}" class="list-group-item rounded ">
        <div class="form-group mb-1 row">
            <div class="col-9 mb-1">
                <button type="button" class="btn btn-sm btn-outline-secondary disabled fs-10 mb-1 p-1 font-weight-bold">#{{$d->id}}</button>
                <button type="button" class="btn btn-sm btn-outline-secondary disabled fs-10 mb-1 p-1"><i class="fas fa-layer-group"></i> {{@$d->cicloEtapa->ciclo}} / {{@$d->cicloEtapa->ciclo_etapa}}</button>
                <button type="button" class="btn btn-sm btn-outline-secondary disabled fs-10 mb-1 p-1"><i class="fas fa-book"></i> {{$d->disciplina->titulo}}</button>
                <button type="button" class="btn btn-sm btn-outline-secondary disabled fs-10 mb-1 p-1"><i class="fas fa-ruler-vertical"></i> {{$dificuldade[$d->dificuldade]}}</button>
                <button type="button" class="btn btn-sm btn-outline-secondary disabled fs-10 mb-1 p-1"><i class="fas fa-lightbulb"></i> {{@$d->bncc->codigo_habilidade}}</button>
                @if($d->fonte)
