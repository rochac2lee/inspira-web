            ...
            <div class="row">
                <div class="col-md-12 mt-1">
                    <h4 class="pb-1 border-bottom mb-4">
                        ...
                        @if ( strpos(Request::path(),'editar')===false )Nova playlist @else Editar playlist @endif
                    </h4>
                    <div class="card">
                        <div class="card-header">Dados da playlist</div>
                        <div class="card-body">
                            <div class="filter">
                                <form id="formCadastro" action="@if ( strpos(Request::path(),'editar') ){{url('/gestao/cast/playlist/editar/')}}@else{{url('/gestao/cast/playlist/add/')}}@endif" method="post">
                                    @csrf
                ...
                <div class="col-md-7 pl-4">
                    ...
                    <a href="{{url('/gestao/cast?tipo=2')}}" class="btn btn-secondary float-left">Cancelar</a>
