    ...
    <div class="row">
        <div class="col-md-12">
            <h4 class="pb-1 border-bottom mb-4">
                @if(!isset($revisar))
                    <a href="{{url('/avaliacao_ead/gestao/questao/')}}" class="btn btn-secondary ml-3">
                        <i class="fas fa-arrow-left"></i>
                    </a>
                @else
                    <a href="{{url('avaliacao_ead/gestao/avaliacao/revisao/'.$avaliacao_id)}}" class="btn btn-secondary ml-3">
                        <i class="fas fa-arrow-left"></i>
                    </a>
                @endif
                EAD - @if ( strpos(Request::path(),'editar')===false )Nova questão @else Editar questão @endif
            </h4>
        </div>
    </div>
	    ...
	    <div class="container-fluid">
	        ...
	        <div class="row">
	            ...
	            <div class="col-md-6 pl-5">
                    ...
                    @if(!isset($revisar))
	                    <a href="{{url('/avaliacao_ead/gestao/questao/')}}" class="btn btn-secondary float-left" >Cancelar</a>
                    @else
                        <a href="{{url('avaliacao_ead/gestao/avaliacao/revisao/'.$avaliacao_id)}}" class="btn btn-secondary float-left" >Cancelar</a>
                    @endif
