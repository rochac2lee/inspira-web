    ...
    <section class="section section-interna" style="padding-bottom: 15px" >
        <div class="container">
            <h2 class="title-page">
                ...
                Avaliação INdica - {{$avaliacao->titulo}}
            </h2>
        </div>
        ...
        <div class="container">
            <div class="avaliacao-online mt-0">
                <div class="pergunta text-center">
                    ...
                    <div class="mt-4">Parabéns, você finalizou a Avaliação INdica</div>
                    ...
                    <div class="col-md-6 bg-light border-right pt-4 pb-4 pl-4 pr-5">
                        ...
                        <div class="col border p-2 text-center statsPerformace">
                            ...
                            <div class="row">
                                ...
                                <div class="col col-md-12"><div class="a a4"><label>{{$dados->tempo_total}}</label> Tempo total nesta avaliação (h:m:s)</div></div>
                            </div>
                        </div>
