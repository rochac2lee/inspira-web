...
<section class="section">
    ...
    <div class="container">
        ...
        <h2 class="text-left mt-3" >
            @php $i=1; @endphp
            <form id="formFinalizar" method="post" action="{{url('avaliacao_ead/avaliacao/finalizar')}}">
                @csrf
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="">
                    <div class="row">
                        <div class="col-12">
                            Você está prestes a finalizar a sua avaliação, verifique se todas as questões foram respondidas.
                            <!--<p><b id="tituloAvaliacao"></b></p>-->
                            <br><br>
                            <p ><b class="text-danger">Ao clicar em "SIM, FINALIZAR", sua prova será encerrada. Tem certeza de que deseja finalizar?</b> </p>
                        </div>
                    </div>
                </form>
            </div>
