...
<section class="section bg-dark text-white py-2">
    <div class="container-fluid">
        <div class="path p-1">
            <h5>
                <a href="#" onclick="window.history.go(-1);" title="Voltar" class="btn btn-secondary mr-3">
...
<section class="section">
    <div class="container-fluid">
        <div class="row">
                ...
                <div class="accordion faq" id="accordionExample">
                    ...
                    <div class="card m-0">
                        ...
                        <div id="collapse4" class="collapse" aria-labelledby="heading4" data-parent="#accordionExample">
                          <div class="card-body">
                            Em caso de dúvidas, fale conosco: atendimentote@opeteducation.com.br ou 0800-41-0034 (segunda a sexta-feira, das 08:00 às 17:30).
                          </div>
                        </div>
                    </div>
            ...
            <div class="col-md-5 p-4" style="background-color: #FFFFFF">
                <form id="form" method="post" action="{{url('contato')}}">
                    ...
                    <button type="button" data-sitekey="{{config('app.GOOGLE_RECAPTCHA_KEY')}}" data-callback='onSubmit' class="g-recaptcha btn btn-default mt-0 float-right ml-2">Enviar Contato</button>
                </form>
            </div>
