...
<li><a href="javascript:void(0)" class="has-submenu"><div class="ico conteudo"></div>Conteúdos <i class="fas fa-sort-down"></i></a>
    <ul class="submenu">
        ...
        <li><a href="https://learn.eltngl.com/?_ga=2.199148079.1406641445.1695911952-1521637895.1695911950" target="blank_"><div class="ico natgeo"></div>Look</a></li> 
        @endif       
        <!--
        Não utilizado
        ...
        <li><a href="{{ url('/editora/conteudos/colecao?conteudo=105')}}"><div class="ico estrutura_trimestral"></div>Estrutura Trimestral</a></li>
        @endif 
