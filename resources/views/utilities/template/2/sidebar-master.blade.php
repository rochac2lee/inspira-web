<div id="sidebar">
    ...
    -->
      <li><a href="{{ url('colecao_livro') }}">Livro Digital</a></li>
      <li><a href="{{ url('editora/conteudos/colecao?conteudo=100') }}">Banco de Imagens</a></li>
      <li><a href="{{ route('gestao.cursos') }}">Roteiros de Estudo</a></li>
     <!-- <li><a href="{{route('gestao.cursoslivres')}}">Cursos Livres</a></li>-->
      <li><a href="{{ url('/gestao/trilhas') }}">Trilhas </a></li>
      <li><a href="{{url('gestao/entregaveis')}}"> Gestão de entregáveis</a></li>
