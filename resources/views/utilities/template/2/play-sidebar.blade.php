<div id="sidebar">
        ...
        <ul class="side-group">
          ...
          <!-- <li><a href="{{ route('home') }}">Estatísticas</a></li> -->
          <li><a href="{{ url('catalogo') }}">Início</a></li>
          <li><a href="{{ route('aluno.grade-aula.index', ['date' => date('Y-m-d'), 'turma' => 'todas']) }}">Grade de {{$langAula}}</a></li>
          ...
          {{-- <li><a href="{{ route('playlists.listar') }}">{{$langPlaylist}}</a></li> --}}
          ...
          <li>
            ...
            <ul class="submenu">
              ...
              <li><a href="#">Mural da Escola </a></li>
