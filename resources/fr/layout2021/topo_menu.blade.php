                ...
                <li>
                    ...
                    <div class="main-menu submenu-list">
                        <div class="main">
                            ...
                            <li><a href="{{url('/editora/conteudos?conteudo=3&etapa=4')}}"><div class="ico conteudo"></div>Mural da escola</a></li>
                                <li><a href="{{url('/editora/conteudos/colecao?conteudo=102')}}"><div class="ico provas-bimestrais"></div>Provas Bimestrais</a></li>
                                <li><a href="{{url('/editora/conteudos/colecao?conteudo=105')}}"><div class="ico tabelas-bncc"></div>Estrutura Trimestral</a></li>
