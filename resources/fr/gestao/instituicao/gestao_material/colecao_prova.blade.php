...
@section('content')
    ...
    <section class="section section-interna">
        <div class="container">
            ...
            <h2 class="title-page">
                ...
                Coleções de Provas Permitidas<br><small>{{$instituicao->titulo}}</small>
            </h2>
                <form action="{{url('/gestao/instituicao/material/addColecaoProva/')}}" method="post">
                    <div class="form-row">
                    ...
                    @foreach($dados as $d)
                        <div class="col-md-6 grid-item">
                            <div class="card text-center">
                                <div class="card-body">
                                    <div class="img">
                                        <img class="img-fluid" src="{{ config('app.cdn').'/storage/colecaoprova/'.$d->img}}" />
                                    </div>
                                </div>
                                <div class="card-footer">
                                    ...
                                    <div id="etapa{{$d->id}}" style="display: none;" class="text-left">
                                        <form action="{{url('/gestao/instituicao/material/permissaoColecaoProva')}}" method="post" >
                                            <br><br>
                                            @csrf
                                            <input type="hidden" name="instituicao_id" value="{{$instituicao->id}}">
    ...
    <script>
        ...
        function excluir()
        {
            window.location.href = '{{url('/gestao/instituicao')}}/' + vinstituicaoId + '/material/removerColecaoProva/' + vcolecaoId;
        }
