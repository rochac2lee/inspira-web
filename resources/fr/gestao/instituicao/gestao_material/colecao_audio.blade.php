...
@section('content')
    ...
    <section class="section section-interna">
        <div class="container">
            ...
            <h2 class="title-page">
                ...
                Coleções de Áudios Permitidos<br><small>{{$instituicao->titulo}}</small>
            </h2>
                <form action="{{url('/gestao/instituicao/material/addColecaoAudio/')}}" method="post">
                    <div class="form-row">
                    ...
                    @foreach($dados as $d)
                        <div class="col-md-6 grid-item">
                            <div class="card text-center">
                                <div class="card-body">
                                    <div class="img">
                                        <img class="img-fluid" src="{{ config('app.cdn').'/storage/colecaoaudio/'.$d->img}}" />
                                    </div>
                                </div>
                                <div class="card-footer">
                                    ...
                                    <div id="etapa{{$d->id}}" style="display: none;" class="text-left">
                                        <form action="{{url('/gestao/instituicao/material/permissaoColecaoAudio')}}" method="post" >
                                            <br><br>
                                            @csrf
                                            <input type="hidden" name="instituicao_id" value="{{$instituicao->id}}">
                ...
                <div class="col">
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Essa instituição ainda não possui coleções de áudio adicionadas.</p>
                        </div>
    ...
    <script>
        ...
        function excluir()
        {
            window.location.href = '{{url('/gestao/instituicao')}}/' + vinstituicaoId + '/material/removerColecaoAudio/' + vcolecaoId;
        }
