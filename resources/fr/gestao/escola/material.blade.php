        ...
        <div class="row pt-4 pb-4">
            <div class="col-md-8">
                ...
                <h3>
                    ...
                    Gestão de Material <br><small>{{$escola->titulo}}</small>
                </h3>
            </div>
        </div>
        <div class="quadro-atividades">
            <div class="row d-flex">
                <div class="col-sm-6 col-md-2 my-4">
                    <a href="{{url('/gestao/escola/'.$escola->id.'/material/colecaoLivro')}}" class="item">
                        <img src="{{config('app.cdn')}}/fr/imagens/icones/livro_didático.png" />
                        <span class="title">Livro Digital</span>
                    </a>
                </div>
                <div class="col-sm-6 col-md-2 my-4">
                    <a href="{{url('/gestao/escola/'.$escola->id.'/material/colecaoAudio')}}" class="item">
                        <img src="{{config('app.cdn')}}/fr/imagens/icones/audio.png" />
                        <span class="title">Áudio</span>
                    </a>
                </div>
                <div class="col-sm-6 col-md-2 my-4">
                    <a href="{{url('/gestao/escola/'.$escola->id.'/material/colecaoProva')}}" class="item">
                ...
                <!--
                <div class="col-sm-6 col-md-2 my-4">
                    <a href="{{url('/gestao/escola/'.$escola->id.'/material/colecaoDocumento')}}" class="item">
