...
@section('content')
                                    ...
                                    <td class="text-right">
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="/gestao/escola/{{$escola->id}}/docentes/logar/{{$d->id}}" class="dropdown-item">Logar</a>
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Importação de arquivos de docentes</h5>
            </div>
            <div class="modal-body">
                <form action="{{url('/gestao/escola/importacao/docentes')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="escola_id" value="{{$escola->id}}">
                    <input type="hidden" name="instituicao_id" value="{{$escola->instituicao_id}}">
                    <div class="row">
                        <div class="col-12">
