			...
			<div class="modal-body">
				<form id="formFormulario" action="" method="post" enctype="multipart/form-data">
            		...
            		<div class="row">
                		<div class="col-4">
                    		<div class="form-group">
	                        	...
	                        	<div id="logoCadastro" class="form-group imagem-file-roteiro bg-secondary text-white rounded p-1 text-center">
	                                ...
	                                <img id="imgLogo" width="328px" src="{{ config('app.cdn').'/storage/logo_instituicao/'.old('existeImg')}}">
	                                <br>
                    	...
                    	<div class="col-12 mt-3 mb-4 border-bottom "><label class="font-weight-bold">ADMINISTRADORES</label></div>
                    	<div class="col-6">
            				<div class="form-group">
	                        	<label>Nome do Responsável *</label>
	                        	<input type="text" name="adm_escola" value="{{old('adm_escola')}}" placeholder="" class="form-control rounded {{ $errors->has('adm_escola') ? 'is-invalid' : '' }}">
                    	...
                    	<div class="col-6">
            				<div class="form-group">
	                        	<label>E-mail *</label>
	                        	<input type="text" name="adm_email" value="{{old('adm_email')}}" placeholder="" class="form-control rounded {{ $errors->has('adm_email') ? 'is-invalid' : '' }}">
