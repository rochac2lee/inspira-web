...
class CreateIndicaAvaliacaoLogAtividade extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('indica_avaliacao_log_atividade', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('indica_avaliacao_log_atividade');
    }
}
