...
class CreateCursoAulaUsuarioDiscursiva extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('curso_aula_usuario_discursiva', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('curso_aula_usuario_discursiva');
    }
}
