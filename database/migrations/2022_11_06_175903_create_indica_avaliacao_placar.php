...
class CreateIndicaAvaliacaoPlacar extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('indica_avaliacao_placar', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('indica_avaliacao_placar');
    }
}
